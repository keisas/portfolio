...
const events: Event[] = [
  ...
  { date: "2025年6月", title: "情報処理学会第82回バイオ情報学研究会", color: "#10B981" },
  { date: "2025年8月", title: "短期インターン\n (株式会社ソニー・インタラクティブエンタテインメント)", color: "#E879F9" },
  { date: "2025年10月", title: "CBI学会2025年大会\nポスター発表", color: "#10B981" },
  { date: "2025年11月", title: "修士論文構想発表会\n口頭発表", color: "#10B981" },
  { date: "2025年12月", title: "学内ハッカソン参加", color: "#FBBF24" },
