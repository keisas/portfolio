...
export default function WelcomeSection() {
  ...
  const handleSend = async () => {
    ...
    setInput("");
    setLoading(true);
    setMessages(() => [{ role: "system", content: "..." }]); // Loading message
    ...
    try {
      ...
      if (reader) {
        while (true) {
          ...
          console.log("Chunk:", chunk); // Debugging log
...
//     try {
//       const res = await fetch("https://api.yonecoding.com/ask", {
//         method: "POST",
//         headers: {
...
//       const systemMessage = { role: "system", content: data.answer };
      
//       // data.categoryのlog
//       console.log("Category:", data.category);
//       switch (data.category) {
//         case "自己紹介":
//           setAvatarImage(avatarNormalImg);
//           break;
//         case "技術":
//           setAvatarImage(avatarDevImg);
//           break;
//         case "キャリア":
//           setAvatarImage(avatarFormalImg);
//           break;
//         case "研究・学業":
//           setAvatarImage(avatarSchoolImg);
//           break;
//         case "雑談":
//           setAvatarImage(avatarNormal2Img);
//           break;
//         default:
//           setAvatarImage(avatarNormal2Img);
//           break;
...
//   return (
//     <div className="welcome-container">
//       <CharacterWithBubble text={messages[0].content} question={question.content} avatar={avatarImage} />
